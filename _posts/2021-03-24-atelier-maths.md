...
L’objectif de cet atelier était de [s’amuser à tracer des rosaces et de revoir ainsi des notions mathématiques vues à l’école]({% post_url 2021-03-21-presentation-atelier-maths-rosaces %}#/objectifs).

Nous avons étudié le problème de tracé de figures régulières sur le cercle en [utilisant seulement la règle et le compas]({% post_url 2021-03-21-presentation-atelier-maths-rosaces %}#/constructions-%C3%A0-la-r%C3%A8gle-et-au-compas). Il peut se décliner en [différents problèmes équivalents selon les niveaux]({% post_url 2021-03-21-presentation-atelier-maths-rosaces %}#/un-m%C3%AAme-probl%C3%A8me-sous-plusieurs-angles).
...
Nous avons ensuite revu comment tracer la [rosace classique à 6 pétales]({% post_url 2021-03-21-presentation-atelier-maths-rosaces %}#/la-rosace-%C3%A0-6-p%C3%A9tales) qui est équivalent au tracé d’un hexagone régulier ! On vérifie que 360°/6 = 60°, ce qui correspond aux angles des six triangles équilatéraux tracés.

Comme pour les gâteaux, on peut toujours [doubler le nombre de pétales]({% post_url 2021-03-21-presentation-atelier-maths-rosaces %}#/rosace-d%C3%A9doubl%C3%A9e) (6, 12, 24, 48, 96….) ou utiliser les diviseurs (1, 2, 3, 6) pour [extraire des pétales]({% post_url 2021-03-21-presentation-atelier-maths-rosaces %}#/rosace-extraite).
...
La rosace classique utilise pour ses pétales des arcs de même rayon que celui du cercle dans lequel elle est inscrite. On vérifie que [leur largeur est un quart du rayon]({% post_url 2021-03-21-presentation-atelier-maths-rosaces %}#/taille-des-p%C3%A9tales-13).
...
On a ensuite tracé des [rosaces à cinq pétales]({% post_url 2021-03-21-presentation-atelier-maths-rosaces %}#/rosace-%C3%A0-5-p%C3%A9tales) et constaté les difficultés et imprécisions que cela peut comporter. Enfin nous avons vu comment [« fusionner » deux rosaces]({% post_url 2021-03-21-presentation-atelier-maths-rosaces %}#/rosace-%C3%A0-5-p%C3%A9tales). Par exemple, la fusion des rosaces à 4 et 6 pétales donne la rosace à 12 = PPCM(4, 6) pétales.
