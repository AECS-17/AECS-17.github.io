...
Cet après-midi les enfants sont venus au local pour le premier [atelier bandes dessinées]({% post_url 2020-11-05-presentation-atelier-bandes-dessinees %}). Ils ont notamment pu se familiariser avec le logiciel [BDnF](https://bdnf.bnf.fr/) afin de créer leur propres bandes dessinées et présenter ensuite le résultat à leurs camarades.
